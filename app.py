...
def configure_app(app):
    ...
    if 'SECRETS_FILE' in os.environ:
        ...
        try:
            app.config['FRED_API_KEY'] = os.environ['FRED_API_KEY']
        except SyntaxError:
            app.logger.error("Invalid FRED API key '{}', aborting...", os.environ['FRED_API_KEY'])
    else:
        app.logger.error("Required FRED API key not provided, aborting...")
